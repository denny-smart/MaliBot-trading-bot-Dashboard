                    ...
                    <div className="flex items-center gap-2">
                      <Badge
                        className={cn(
                          ...
                          trade.direction === 'UP' ? 'bg-success/20 text-success hover:bg-success/30' : 'bg-rose-500/20 text-rose-500 hover:bg-rose-500/30'
                        )}
                      >
                        {trade.direction}
                      </Badge>
                  ...
                  {trade.profit !== undefined && (
                    <p
                      className={cn(
                        ...
                        trade.profit >= 0 ? 'text-success' : 'text-rose-500'
                      )}
                    >
                      {trade.profit >= 0 ? '+' : ''}
