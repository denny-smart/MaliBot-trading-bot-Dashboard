      ...
      <Tabs defaultValue="active" className="space-y-6">
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div className="space-y-1">
                ...
                <p className="text-xs text-zinc-500">
                  Strategy context:{' '}
                  <span className="font-semibold text-success">{accountStrategy}</span>
                </p>
              </div>
              <Button
          ...
          <div className="flex flex-wrap gap-3 items-center bg-zinc-900 border border-zinc-800 rounded-2xl p-4">
            <div className="relative flex-1 min-w-[200px]">
              ...
              <Input
                ...
                className="pl-10 bg-zinc-800 border-zinc-700 text-zinc-100 placeholder:text-zinc-500 focus:border-primary/50 focus:ring-primary/20"
              />
            </div>
            <Select value={directionFilter} onValueChange={setDirectionFilter}>
              <SelectTrigger className="w-[150px] bg-zinc-800 border-zinc-700 text-zinc-300 hover:border-zinc-600 focus:border-primary/50">
            ...
            <Select value={statusFilter} onValueChange={setStatusFilter}>
              <SelectTrigger className="w-[140px] bg-zinc-800 border-zinc-700 text-zinc-300 hover:border-zinc-600 focus:border-primary/50">
            ...
            <Select value={strategyFilter} onValueChange={setStrategyFilter}>
              <SelectTrigger className="w-[155px] bg-zinc-800 border-zinc-700 text-zinc-300 hover:border-zinc-600 focus:border-primary/50">
        ...
        <TabsContent value="stats" className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            {/* Win Rate */}
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 flex flex-col gap-1 hover:border-primary/40 transition-colors">
              <p className="text-xs font-medium text-zinc-500 uppercase tracking-widest">Win Rate</p>
              <p className="text-3xl font-bold text-success mt-1">{(stats?.win_rate || 0).toFixed(1)}%</p>
            </div>
            {/* Total Profit */}
            <div className={cn(
              'bg-zinc-900 border rounded-2xl p-5 flex flex-col gap-1 transition-colors',
              (stats?.total_profit || 0) >= 0 ? 'border-primary/40 hover:border-primary/60' : 'border-rose-800/40 hover:border-rose-700/60'
            )}>
              <p className="text-xs font-medium text-zinc-500 uppercase tracking-widest">Total Profit</p>
              <p className={cn('text-3xl font-bold mt-1', (stats?.total_profit || 0) >= 0 ? 'text-success' : 'text-rose-500')}>
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 flex flex-col gap-1 hover:border-primary/40 transition-colors">
              ...
              <p className="text-3xl font-bold text-success mt-1">{formatCurrency(stats?.avg_win || 0)}</p>
            </div>
            {/* Avg Loss */}
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 flex flex-col gap-1 hover:border-primary/40 transition-colors">
              ...
              <p className="text-3xl font-bold text-success mt-1">{formatCurrency(stats?.largest_win || 0)}</p>
            </div>
            {/* Largest Loss */}
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 flex flex-col gap-1 hover:border-rose-800/40 transition-colors">
